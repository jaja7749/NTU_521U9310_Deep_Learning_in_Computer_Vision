...
```
    ...
    Episode 99 - Step 17631 - Epsilon 0.9956019493240981 - Mean Reward 145.45 - Mean Length 176.31 - Mean Loss 0.358 - Mean Q Value 0.025 - Time Delta 13.1 - Time 2024-06-02T17:45:03
...
spaceinvader = SI(state_dim=(4, 84, 64), action_dim=env.action_space.n, save_dir=save_dir)
checkpoint = torch.load("./checkpoints/2024-05-12T02-12-19/mario_net_44.chkpt")
...
```
    ...
    Step:  372 , Observation: (4, 84, 64) , Reward: 0.0 , Reward_tot: 575.0 , Terminated and Truncated: True , Info: {'lives': 0, 'episode_frame_number': 4524, 'frame_number': 4524}}}
